...
import { ZodiacIcon, TarotIcon, NumerologyIcon, BaZiIcon } from "@/components/icons/mystical-icons";
  ...
  return (
    <main className="relative flex min-h-dvh flex-col items-center overflow-hidden">
      ...
      <section className="relative w-full">
        ...
        {/* CTA Overlay — positioned over the banner */}
        <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center pb-12 md:pb-16 z-10 px-4">
      ...
      {/* Donation Section */}
      <section className="relative z-10 w-full max-w-2xl px-4 pb-24 text-center">
