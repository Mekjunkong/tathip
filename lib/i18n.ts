...
export const translations = {
  th: {
    ...
    tarotTitle: "ดูไพ่ทาโรต์",
    tarotSubtitle: "แตะไพ่เพื่อเปิดทีละใบ",
    shuffle: "สับไพ่ใหม่",
    cutCards: "ตัดไพ่",
    readFortune: "ทำนาย",
    selectedCards: "เลือกแล้ว",
    cardOf: "ใบ",
    ...
    future: "อนาคต",
    drawCards: "จั่วไพ่",
    revealAll: "เปิดไพ่ทั้งหมด",
    newReading2: "เริ่มดูใหม่",
    askTathip: "ถามตาทิพย์เพิ่มเติม",
    uprightMeaning: "ไพ่หงาย",
    reversedMeaning: "ไพ่คว่ำ",
    tarot: "ไพ่ทาโรต์",
  },
  en: {
    siteName: "TaThip",
    ...
    tarotSubtitle: "Tap a card to reveal it",
    ...
    newReading2: "New Reading",
    askTathip: "Ask TaThip for more",
